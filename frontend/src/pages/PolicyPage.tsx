      ...
      <MobileFrame>
        <div className="w-full h-full mobile-safe-area flex flex-col">
          ...
          <header className="px-4 pt-3 pb-2 flex items-center justify-between relative bg-white">
            <BackButton />
            <h1 className="text-lg font-semibold absolute left-1/2 transform -translate-x-1/2">콕! 맞는 정부 지원정책</h1>
        ...
        {recommendList.length > 0 && (
          <div className="px-4 py-3">
            <p className="text-[#4293A0] text-sm leading-relaxed">
              김OO님의 현재 등록된 영농 정보에 맞춰 가입할 수 있는 지원원정책을 추천드려요.
            </p>
          </div>
        )}
            ...
            {recommendList.length > 0 ? (
              <div className="mb-4">
                {recommendList.map((product) => (
                    <div key={product.policyId} className="bg-white p-4 border border-gray-100 mb-3">
            ...
            <div className="py-3">
              ...
              <div className="space-y-3">
                {otherList.map((product) => (
                    <div key={product.policyId} className="bg-white  p-4 border border-gray-100">
