    ...
    <MobileFrame>
      <div className="w-full h-full bg-gray-50 mobile-safe-area flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          ...
          <div className="text-[16px] text-gray-700 leading-relaxed mb-8">
        ...
        <div className="px-6 pb-6 space-y-3">
          <button 
            ...
            className="w-full h-12 bg-teal-100 text-gray-700 rounded-lg font-medium"
          >
            내 농장 추가 등록하기
          </button>
          <button 
            onClick={() => navigate('/manage')}
            className="w-full h-12 bg-teal-600 text-white rounded-lg font-medium"
          >
            MY 영농/농장 정보 보러가기
          </button>
        </div>
